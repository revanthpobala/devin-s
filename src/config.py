...
# LEVEL_PINE_DRIFT_ATR: flag Pine drift when LLM levels differ from Pine
#   Long Entry Zone Bot/Top, Long Stop Loss or Long Target by more than
#   this many ATR (default 2.0).
