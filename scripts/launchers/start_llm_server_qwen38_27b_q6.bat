...
REM -c 131072: 128k context (single slot for prompt cache reuse)
REM -fa on: Flash Attention
REM -ctk q8_0 -ctv q8_0: Quantized KV Cache
REM -ngl 999: Offload all layers across GPUs
D:\My-Projects\Stock\llama-cpp-server\llama-server.exe -m "D:\My-Projects\Stock\models\Qwen3.8-27B-UD-Q6_K_XL.gguf" --mmproj "D:\My-Projects\Stock\models\mmproj-Qwen3.8-27B-F16.gguf" --host 127.0.0.1 --port 8000 -c 131072 --parallel 1 -fa on -ctk q8_0 -ctv q8_0 -ngl 999 -a "gpt-4" --jinja -lv 4 --log-file "%LLM_LOG%"
