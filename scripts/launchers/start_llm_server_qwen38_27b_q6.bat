...
REM -b 512 -ub 256: Lean execution batch size to minimize compute buffers
REM -ngl 999: 100% GPU Offload (66/66 layers offloaded, Zero CPU RAM spillover)
REM Total Footprint: 20.47 GB (Model) + 1.15 GB (Vision) + 4.30 GB (KV Cache) + 1.20 GB (Compute) = ~27.12 GB (Fits in 32GB VRAM!)
REM
...
REM - Thinking Mode:                      --temp 1.0 --top-p 0.95 --top-k 20 --min-p 0.0 --presence-penalty 0.0 --repeat-penalty 1.0 --reasoning on
REM
D:\My-Projects\Stock\llama-cpp-server\llama-server.exe -m "D:\My-Projects\Stock\models\Qwen3.8-27B-UD-Q6_K.gguf" --mmproj "D:\My-Projects\Stock\models\mmproj-Qwen3.8-27B-F16.gguf" --host 127.0.0.1 --port 8000 -c 262144 --parallel 1 -fa on -ctk q4_0 -ctv q4_0 -b 512 -ub 256 -ngl 999 --split-mode layer --temp 0.7 --top-p 0.80 --top-k 20 --min-p 0.0 --presence-penalty 1.5 --repeat-penalty 1.0 -a "qwen,gpt-4,qwen-coder,qwen3.8-27b" --jinja --reasoning off -lv 3 --log-file "%LLM_LOG%"
